 ...
 */
public class RecupObjetBoutique extends AsyncTask<String, Integer, String> {
    private static final String chemin_acces_script= "http://"+ParametreConnexion.adresseIP+"/projet/ScriptJeu/boutique.php";
    private int idU;
    public String resultat;
    public RecupObjetBoutique(int id){
        idU=id;
        resultat="";
    }
    @Override
